...
func init() {
	...
	utilruntime.Must(kymagwv2.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e5cc800c.sundew.com",
	...
	if err := (&controller.CloudActiveDefenseReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "CloudActiveDefense")
		os.Exit(1)
	}
